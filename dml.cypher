...
CREATE (person1)-[:IS_TEAM_MEMBER{role:"developer"}]->(project1)
CREATE (person1)-[:IS_TEAM_MEMBER{role:"developer"}]->(project2)
CREATE (person1)-[:IS_TEAM_MEMBER{role:"tester"}]->(project3)
CREATE (person1)-[:IS_TEAM_MEMBER{role:"architekt"}]->(project5)
CREATE (person2)-[:IS_TEAM_MEMBER{role:"product owner"}]->(project4)
CREATE (person2)-[:IS_TEAM_MEMBER{role:"scrum master"}]->(project5)
CREATE (person2)-[:IS_TEAM_MEMBER{role:"developer"}]->(project6)
CREATE (person2)-[:IS_TEAM_MEMBER{role:"system administrator"}]->(project7)
CREATE (person3)-[:IS_TEAM_MEMBER{role:"support"}]->(project3)
